...
-- Emojis and shortcodes sourced from github's API
--
-- #!/bin/bash
-- # Add emoji presentation variation selector.
-- # See https://en.wikipedia.org/wiki/Emoji#Emoji_versus_text_presentation
-- modifiers="\\Ufe0f"
-- 
-- regex=".*unicode\/([0-9a-z-]+).png.*"
-- while IFS=$'\t' read -r key value; do
--   if [[ $value =~ $regex ]]; then
--     value="${BASH_REMATCH[1]}"
--     printf "  ['%s'] = '" "${key}"
-- 
--     # Do not join codepoints if this is a flag.
--     is_flag=false
--     for code in ${value//-/ }; do
--       if [[ 0x$code > 0x1f1e5 && 0x$code < 0x1f200 ]]; then
--         is_flag=true
--       fi
--     done <<< "${value}"
-- 
...
--     for code in ${value//-/ }; do
--       is_mod=false
--       if [[ 0x$code > 0x20cf && 0x$code < 0x2100 ]]; then
--         is_mod=true
--       fi
-- 
--       # Join codepoints with zero width joiner (U+200d).
--       if [[ $is_first != "true" && $is_flag != "true" && $is_mod != "true" ]]; then
--         printf "%b" "\\U200d"
--       elif [[ $is_first == "true" ]]; then
--         is_first=false
--       fi
--       if [[ $is_flag == "true" || $is_mod == "true" ]]; then
--         printf "%b" "\\U${code}"
--       else
--         printf "%b" "\\U${code}${modifiers}"
--       fi
--     done <<< "${value}"
-- 
--     printf "',\n"
--   else
--     printf "  --['%s'] = '%b', -- not unicode\n" "${key}" "\\Ufffd"
--   fi
-- done < <(curl -Ls "https://api.github.com/emojis" | jq -r 'to_entries[] | "\(.key)\t\(.value)"')
local emojis = {
  ['+1']                                       = '👍️',
  ['-1']                                       = '👎️',
  ['100']                                      = '💯️',
  ...
  ['barber']                                   = '💈️',
  ['baseball']                                 = '⚾️',
  --['basecamp']                               = '�', -- not unicode
  --['basecampy']                              = '�', -- not unicode
  ['basket']                                   = '🧺️',
  ['basketball']                               = '🏀️',
  ['basketball_man']                           = '⛹️‍♂️',
  ...
  ['black_square_button']                      = '🔲️',
  ['blond_haired_man']                         = '👱️‍♂️',
  ['blond_haired_person']                      = '👱️',
  ['blond_haired_woman']                       = '👱️‍♀️',
  ['blonde_woman']                             = '👱️‍♀️',
  ['blossom']                                  = '🌼️',
  ['blowfish']                                 = '🐡️',
  ['blue_book']                                = '📘️',
  ...
  ['busstop']                                  = '🚏️',
  ['bust_in_silhouette']                       = '👤️',
  ['busts_in_silhouette']                      = '👥️',
  ['butter']                                   = '🧈️',
  ['butterfly']                                = '🦋️',
  ['cactus']                                   = '🌵️',
  ['cake']                                     = '🍰️',
  ...
  ['champagne']                                = '🍾️',
  ['chart']                                    = '💹️',
  ['chart_with_downwards_trend']               = '📉️',
  ['chart_with_upwards_trend']                 = '📈️',
  ['checkered_flag']                           = '🏁️',
  ['cheese']                                   = '🧀️',
  ['cherries']                                 = '🍒️',
  ['cherry_blossom']                           = '🌸️',
  ...
  ['construction_worker_man']                  = '👷️‍♂️',
  ['construction_worker_woman']                = '👷️‍♀️',
  ['control_knobs']                            = '🎛️',
  ['convenience_store']                        = '🏪️',
  ['cook']                                     = '🧑️‍🍳️',
  ['cook_islands']                             = '🇨🇰',
  ...
  ['couple']                                   = '👫️',
  ['couple_with_heart']                        = '💑️',
  ['couple_with_heart_man_man']                = '👨️‍❤️‍👨️',
  ['couple_with_heart_woman_man']              = '👩️‍❤️‍👨️',
  ['couple_with_heart_woman_woman']            = '👩️‍❤️‍👩️',
  ['couplekiss']                               = '💏️',
  ['couplekiss_man_man']                       = '👨️‍❤️‍💋️‍👨️',
  ['couplekiss_man_woman']                     = '👩️‍❤️‍💋️‍👨️',
  ['couplekiss_woman_woman']                   = '👩️‍❤️‍💋️‍👩️',
  ['cow']                                      = '🐮️',
  ['cow2']                                     = '🐄️',
  ['cowboy_hat_face']                          = '🤠️',
  ['crab']                                     = '🦀️',
  ...
  ['curacao']                                  = '🇨🇼',
  ['curling_stone']                            = '🥌️',
  ['curly_haired_man']                         = '👨️‍🦱️',
  ['curly_haired_woman']                       = '👩️‍🦱️',
  ['curly_loop']                               = '➰️',
  ['currency_exchange']                        = '💱️',
  ['curry']                                    = '🍛️',
  ['cursing_face']                             = '🤬️',
  ...
  ['eyes']                                     = '👀️',
  ['face_exhaling']                            = '😮️‍💨️',
  ['face_holding_back_tears']                  = '🥹️',
  ['face_in_clouds']                           = '😶️‍🌫️',
  ['face_with_diagonal_mouth']                 = '🫤️',
  ['face_with_head_bandage']                   = '🤕️',
  ['face_with_open_eyes_and_hand_over_mouth']  = '🫢️',
  ['face_with_peeking_eye']                    = '🫣️',
  ['face_with_spiral_eyes']                    = '😵️‍💫️',
  ['face_with_thermometer']                    = '🤒️',
  ['facepalm']                                 = '🤦️',
  ['facepunch']                                = '👊️',
  ['factory']                                  = '🏭️',
  ['factory_worker']                           = '🧑️‍🏭️',
  ...
  ['family']                                   = '👪️',
  ['family_man_boy']                           = '👨️‍👦️',
  ['family_man_boy_boy']                       = '👨️‍👦️‍👦️',
  ['family_man_girl']                          = '👨️‍👧️',
  ['family_man_girl_boy']                      = '👨️‍👧️‍👦️',
  ['family_man_girl_girl']                     = '👨️‍👧️‍👧️',
  ['family_man_man_boy']                       = '👨️‍👨️‍👦️',
  ['family_man_man_boy_boy']                   = '👨️‍👨️‍👦️‍👦️',
  ['family_man_man_girl']                      = '👨️‍👨️‍👧️',
  ['family_man_man_girl_boy']                  = '👨️‍👨️‍👧️‍👦️',
  ['family_man_man_girl_girl']                 = '👨️‍👨️‍👧️‍👧️',
  ['family_man_woman_boy']                     = '👨️‍👩️‍👦️',
  ['family_man_woman_boy_boy']                 = '👨️‍👩️‍👦️‍👦️',
  ['family_man_woman_girl']                    = '👨️‍👩️‍👧️',
  ['family_man_woman_girl_boy']                = '👨️‍👩️‍👧️‍👦️',
  ['family_man_woman_girl_girl']               = '👨️‍👩️‍👧️‍👧️',
  ['family_woman_boy']                         = '👩️‍👦️',
  ['family_woman_boy_boy']                     = '👩️‍👦️‍👦️',
  ['family_woman_girl']                        = '👩️‍👧️',
  ['family_woman_girl_boy']                    = '👩️‍👧️‍👦️',
  ['family_woman_girl_girl']                   = '👩️‍👧️‍👧️',
  ['family_woman_woman_boy']                   = '👩️‍👩️‍👦️',
  ['family_woman_woman_boy_boy']               = '👩️‍👩️‍👦️‍👦️',
  ['family_woman_woman_girl']                  = '👩️‍👩️‍👧️',
  ['family_woman_woman_girl_boy']              = '👩️‍👩️‍👧️‍👦️',
  ['family_woman_woman_girl_girl']             = '👩️‍👩️‍👧️‍👧️',
  ['farmer']                                   = '🧑️‍🌾️',
  ['faroe_islands']                            = '🇫🇴',
  ['fast_forward']                             = '⏩️',
  ['fax']                                      = '📠️',
  ...
  ['firefighter']                              = '🧑️‍🚒️',
  ['fireworks']                                = '🎆️',
  ['first_quarter_moon']                       = '🌓️',
  ['first_quarter_moon_with_face']             = '🌛️',
  ['fish']                                     = '🐟️',
  ['fish_cake']                                = '🍥️',
  ['fishing_pole_and_fish']                    = '🎣️',
  --['fishsticks']                             = '�', -- not unicode
  ['fist']                                     = '✊️',
  ['fist_left']                                = '🤛️',
  ['fist_oncoming']                            = '👊️',
  ['fist_raised']                              = '✊️',
  ...
  ['hand']                                     = '✋️',
  ['hand_over_mouth']                          = '🤭️',
  ['hand_with_index_finger_and_thumb_crossed'] = '🫰️',
  ['handbag']                                  = '👜️',
  ['handball_person']                          = '🤾️',
  ['handshake']                                = '🤝️',
  ['hankey']                                   = '💩️',
  ...
  ['iceland']                                  = '🇮🇸',
  ['id']                                       = '🆔️',
  ['identification_card']                      = '🪪️',
  ['ideograph_advantage']                      = '🉐️',
  ['imp']                                      = '👿️',
  ['inbox_tray']                               = '📥️',
  ['incoming_envelope']                        = '📨️',
  ...
  ['laos']                                     = '🇱🇦',
  ['large_blue_circle']                        = '🔵️',
  ['large_blue_diamond']                       = '🔷️',
  ['large_orange_diamond']                     = '🔶️',
  ['last_quarter_moon']                        = '🌗️',
  ...
  ['lotus']                                    = '🪷️',
  ['lotus_position']                           = '🧘️',
  ['lotus_position_man']                       = '🧘️‍♂️',
  ['lotus_position_woman']                     = '🧘️‍♀️',
  ['loud_sound']                               = '🔊️',
  ['loudspeaker']                              = '📢️',
  ['love_hotel']                               = '🏩️',
  ['love_letter']                              = '💌️',
  ...
  ['man_astronaut']                            = '👨️‍🚀️',
  ['man_beard']                                = '🧔️‍♂️',
  ['man_cartwheeling']                         = '🤸️‍♂️',
  ['man_cook']                                 = '👨️‍🍳️',
  ['man_dancing']                              = '🕺️',
  ['man_facepalming']                          = '🤦️‍♂️',
  ['man_factory_worker']                       = '👨️‍🏭️',
  ['man_farmer']                               = '👨️‍🌾️',
  ['man_feeding_baby']                         = '👨️‍🍼️',
  ['man_firefighter']                          = '👨️‍🚒️',
  ['man_health_worker']                        = '👨️‍⚕️',
  ['man_in_manual_wheelchair']                 = '👨️‍🦽️',
  ['man_in_motorized_wheelchair']              = '👨️‍🦼️',
  ['man_in_tuxedo']                            = '🤵️‍♂️',
  ['man_judge']                                = '👨️‍⚖️',
  ['man_juggling']                             = '🤹️‍♂️',
  ['man_mechanic']                             = '👨️‍🔧️',
  ['man_office_worker']                        = '👨️‍💼️',
  ['man_pilot']                                = '👨️‍✈️',
  ['man_playing_handball']                     = '🤾️‍♂️',
  ['man_playing_water_polo']                   = '🤽️‍♂️',
  ['man_scientist']                            = '👨️‍🔬️',
  ['man_shrugging']                            = '🤷️‍♂️',
  ['man_singer']                               = '👨️‍🎤️',
  ['man_student']                              = '👨️‍🎓️',
  ['man_teacher']                              = '👨️‍🏫️',
  ['man_technologist']                         = '👨️‍💻️',
  ['man_with_gua_pi_mao']                      = '👲️',
  ['man_with_probing_cane']                    = '👨️‍🦯️',
  ['man_with_turban']                          = '👳️‍♂️',
  ['man_with_veil']                            = '👰️‍♂️',
  ['mandarin']                                 = '🍊️',
  ['mango']                                    = '🥭️',
  ...
  ['motor_scooter']                            = '🛵️',
  ['motorcycle']                               = '🏍️',
  ['motorized_wheelchair']                     = '🦼️',
  ['motorway']                                 = '🛣️',
  ['mount_fuji']                               = '🗻️',
  ['mountain']                                 = '⛰️',
  ['mountain_bicyclist']                       = '🚵️',
  ['mountain_biking_man']                      = '🚵️‍♂️',
  ['mountain_biking_woman']                    = '🚵️‍♀️',
  ['mountain_cableway']                        = '🚠️',
  ['mountain_railway']                         = '🚞️',
  ['mountain_snow']                            = '🏔️',
  ['mouse']                                    = '🐭️',
  ...
  ['penguin']                                  = '🐧️',
  ['pensive']                                  = '😔️',
  ['people_holding_hands']                     = '🧑️‍🤝️‍🧑️',
  ['people_hugging']                           = '🫂️',
  ['performing_arts']                          = '🎭️',
  ['persevere']                                = '😣️',
  ['person_bald']                              = '🧑️‍🦲️',
  ['person_curly_hair']                        = '🧑️‍🦱️',
  ['person_feeding_baby']                      = '🧑️‍🍼️',
  ['person_fencing']                           = '🤺️',
  ['person_in_manual_wheelchair']              = '🧑️‍🦽️',
  ['person_in_motorized_wheelchair']           = '🧑️‍🦼️',
  ['person_in_tuxedo']                         = '🤵️',
  ['person_red_hair']                          = '🧑️‍🦰️',
  ['person_white_hair']                        = '🧑️‍🦳️',
  ['person_with_crown']                        = '🫅️',
  ['person_with_probing_cane']                 = '🧑️‍🦯️',
  ['person_with_turban']                       = '👳️',
  ['person_with_veil']                         = '👰️',
  ['peru']                                     = '🇵🇪',
  ['petri_dish']                               = '🧫️',
  ['philippines']                              = '🇵🇭',
  ...
  ['raised_hands']                             = '🙌️',
  ['raising_hand']                             = '🙋️',
  ['raising_hand_man']                         = '🙋️‍♂️',
  ['raising_hand_woman']                       = '🙋️‍♀️',
  ['ram']                                      = '🐏️',
  ['ramen']                                    = '🍜️',
  ['rat']                                      = '🐀️',
  ['razor']                                    = '🪒️',
  ...
  ['slovenia']                                 = '🇸🇮',
  ['small_airplane']                           = '🛩️',
  ['small_blue_diamond']                       = '🔹️',
  ['small_orange_diamond']                     = '🔸️',
  ['small_red_triangle']                       = '🔺️',
  ['small_red_triangle_down']                  = '🔻️',
  ['smile']                                    = '😄️',
  ['smile_cat']                                = '😸️',
  ['smiley']                                   = '😃️',
  ['smiley_cat']                               = '😺️',
  ['smiling_face_with_tear']                   = '🥲️',
  ...
  ['sunny']                                    = '☀️',
  ['sunrise']                                  = '🌅️',
  ['sunrise_over_mountains']                   = '🌄️',
  ['superhero']                                = '🦸️',
  ['superhero_man']                            = '🦸️‍♂️',
  ['superhero_woman']                          = '🦸️‍♀️',
  ['supervillain']                             = '🦹️',
  ['supervillain_man']                         = '🦹️‍♂️',
  ['supervillain_woman']                       = '🦹️‍♀️',
  ['surfer']                                   = '🏄️',
  ['surfing_man']                              = '🏄️‍♂️',
  ['surfing_woman']                            = '🏄️‍♀️',
  ['suriname']                                 = '🇸🇷',
  ...
  ['timer_clock']                              = '⏲️',
  ['timor_leste']                              = '🇹🇱',
  ['tipping_hand_man']                         = '💁️‍♂️',
  ['tipping_hand_person']                      = '💁️',
  ['tipping_hand_woman']                       = '💁️‍♀️',
  ['tired_face']                               = '😫️',
  ['tm']                                       = '™️',
  ['togo']                                     = '🇹🇬',
  ['toilet']                                   = '🚽️',
  ...
  ['tuvalu']                                   = '🇹🇻',
  ['tv']                                       = '📺️',
  ['twisted_rightwards_arrows']                = '🔀️',
  ['two']                                      = '2️⃣',
  ['two_hearts']                               = '💕️',
  ['two_men_holding_hands']                    = '👬️',
  ...
  ['vulcan_salute']                            = '🖖️',
  ['waffle']                                   = '🧇️',
  ['wales']                                    = '🏴️‍󠁧️‍󠁢️‍󠁷️‍󠁬️‍󠁳️‍󠁿️',
  ['walking']                                  = '🚶️',
  ['walking_man']                              = '🚶️‍♂️',
  ['walking_woman']                            = '🚶️‍♀️',
  ['wallis_futuna']                            = '🇼🇫',
  ['waning_crescent_moon']                     = '🌘️',
  ['waning_gibbous_moon']                      = '🌖️',
  ['warning']                                  = '⚠️',
  ['wastebasket']                              = '🗑️',
  ['watch']                                    = '⌚️',
  ['water_buffalo']                            = '🐃️',
  ...
  ['wave']                                     = '👋️',
  ['wavy_dash']                                = '〰️',
  ['waxing_crescent_moon']                     = '🌒️',
  ['waxing_gibbous_moon']                      = '🌔️',
  ['wc']                                       = '🚾️',
  ['weary']                                    = '😩️',
  ['wedding']                                  = '💒️',
  ['weight_lifting']                           = '🏋️',
  ...
  ['white_flag']                               = '🏳️',
  ['white_flower']                             = '💮️',
  ['white_haired_man']                         = '👨️‍🦳️',
  ['white_haired_woman']                       = '👩️‍🦳️',
  ['white_heart']                              = '🤍️',
  ['white_large_square']                       = '⬜️',
  ['white_medium_small_square']                = '◽️',
  ['white_medium_square']                      = '◻️',
  ['white_small_square']                       = '▫️',
  ['white_square_button']                      = '🔳️',
  ['wilted_flower']                            = '🥀️',
  ['wind_chime']                               = '🎐️',
  ['wind_face']                                = '🌬️',
  ['window']                                   = '🪟️',
  ...
  ['woman_astronaut']                          = '👩️‍🚀️',
  ['woman_beard']                              = '🧔️‍♀️',
  ['woman_cartwheeling']                       = '🤸️‍♀️',
  ['woman_cook']                               = '👩️‍🍳️',
  ['woman_dancing']                            = '💃️',
  ['woman_facepalming']                        = '🤦️‍♀️',
  ['woman_factory_worker']                     = '👩️‍🏭️',
  ['woman_farmer']                             = '👩️‍🌾️',
  ['woman_feeding_baby']                       = '👩️‍🍼️',
  ['woman_firefighter']                        = '👩️‍🚒️',
  ['woman_health_worker']                      = '👩️‍⚕️',
  ['woman_in_manual_wheelchair']               = '👩️‍🦽️',
  ['woman_in_motorized_wheelchair']            = '👩️‍🦼️',
  ['woman_in_tuxedo']                          = '🤵️‍♀️',
  ['woman_judge']                              = '👩️‍⚖️',
  ['woman_juggling']                           = '🤹️‍♀️',
  ['woman_mechanic']                           = '👩️‍🔧️',
  ['woman_office_worker']                      = '👩️‍💼️',
  ['woman_pilot']                              = '👩️‍✈️',
  ['woman_playing_handball']                   = '🤾️‍♀️',
  ['woman_playing_water_polo']                 = '🤽️‍♀️',
  ['woman_scientist']                          = '👩️‍🔬️',
  ['woman_shrugging']                          = '🤷️‍♀️',
  ['woman_singer']                             = '👩️‍🎤️',
  ['woman_student']                            = '👩️‍🎓️',
  ['woman_teacher']                            = '👩️‍🏫️',
  ['woman_technologist']                       = '👩️‍💻️',
  ['woman_with_headscarf']                     = '🧕️',
  ['woman_with_probing_cane']                  = '👩️‍🦯️',
  ['woman_with_turban']                        = '👳️‍♀️',
  ['woman_with_veil']                          = '👰️‍♀️',
  ['womans_clothes']                           = '👚️',
  ['womans_hat']                               = '👒️',
  ['women_wrestling']                          = '🤼️‍♀️',
...
local function parse_emoji(ctx)
  local marks = {} ---@type render.md.Mark[]

  -- Find shortcodes using treesitter
  local query = vim.treesitter.query.parse('markdown_inline', [[
    ((inline) @shortcode
      (#lua-match? @shortcode ":[0-9a-z_+]+:"))
    ]])
  for id, node in query:iter_captures(ctx.root, ctx.buf) do
    local capture = query.captures[id]
    local query_start, _, query_end, _ = node:range()
    if capture == 'shortcode' then

      -- The AST node may span multiple lines
      local lines = vim.api.nvim_buf_get_lines(ctx.buf, query_start, query_end + 1, false)
      for i, line in ipairs(lines) do
        local start_row = query_start + i - 1

        -- Find all occurrences in the line
        local index = 1 ---@type integer?
        while index do
          local start_col, end_col, word = line:find(":([0-9a-z_+]+):", index)
          local emoji = emojis[word]
          index = end_col
          if start_col and end_col and emoji then
            marks[#marks + 1] = {
              conceal = true,
              start_row = start_row,
              ...
              opts = {
                ...
                conceal = '',
                hl_mode = 'combine',
                virt_text = { { emoji, "RenderMarkdownEmoji" } },
